...
(async () => {
	...
	Object.entries(DATA[MAIN]).forEach(([_, main]) => {
		const fields1 = ["Name", "Slug", "Description", "Category", "Newsletter"]
		const fields2 = ["Notes", "MP4", "PNG", "GIF", "Version", "Share", "Platform", "References"]
		const feature = {}
		
		fields1.forEach(f => (feature[f]=main[f]))
